...
def to_volunteer(destination, link, name):
    ...
    msg = MIMEText('Привет, {0}! \nТы прошел регистрацию в системе волонтерского движения на олимпиадах и конкурсах НИУ ВШЭ. Для завершения регистрации перейди по ссылке {1}'.format(name, link), 'plain', 'utf-8')
